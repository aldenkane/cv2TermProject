...
Ignoring the previously noted experimental flaws in logging true positives, SIFT descriptors and tfeat descriptors both produce spurious matches. They can both achieve high precision, but both do so with low recall. Increasing the number of training images in the SIFT libraries increases 
