...
bin_image = cv2.imread(str(bin_path), cv2.IMREAD_GRAYSCALE)
bin_image = cv2.resize(bin_image, (0,0), fx = RES_SCALE_BIN, fy = RES_SCALE_BIN)
...
bin_kpts, bin_desc = sift.detectAndCompute(bin_image, None)
